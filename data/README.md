...
This file is used by the C++/CUDA code in this repository. (_See [here](../C%2B%2B/#Evaluating_Ensemble_Model_Combinations) for more information regarding the correct interpretation of this file's contents._)

### ensemble_info.xlsx
This file was created manually from the CSVs created by executing ``python/etc/extract_scalars_from_logs.py``, ``ensemble_data.txt``, and from the standard output generated by the binary compiled from the C++/CUDA code in this repository (_See [here](../C%2B%2B#Evaluating_Ensemble_Model_Combinations) for more information._).
